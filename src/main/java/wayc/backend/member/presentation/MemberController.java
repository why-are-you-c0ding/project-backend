...
public class MemberController {
    ...
    public ResponseEntity<RegisterMemberResponse> createMember(@RequestBody @Validated RegisterConsumerRequest request){
    ...
    public ResponseEntity<RegisterMemberResponse> createSeller(@RequestBody @Validated RegisterSellerRequest request){
        memberService.registerMember(RegisterSellerRequest.toServiceDto(request));
        return ResponseEntity.ok(new RegisterMemberResponse());
    }
    
    @PostMapping("/verification/nick-name")
    public ResponseEntity<ValidateResponse> verifyNickName(@RequestBody @Validated ValidateNickNameRequest request){
    ...
    public ResponseEntity<ValidateResponse> verifyLoginId(@RequestBody @Validated ValidateLoginIdRequest request) {
