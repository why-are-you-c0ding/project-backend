...
public class PostItemRequestDtoFactory {
    ...
    public static PostItemRequestDto createSuccessCase(){
        ...
        PostOptionGroupRequestDto dto1 = new PostOptionGroupRequestDto(Arrays.asList(option1, option2), "optionName1", true);
        PostOptionGroupRequestDto dto2 = new PostOptionGroupRequestDto(Arrays.asList(option3, option4), "optionName2", false);
